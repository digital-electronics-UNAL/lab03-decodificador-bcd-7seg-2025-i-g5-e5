...
Pruebas adicionales se realizaron en FPGA (Cyclone IV), [verificando el comportamiento físico de los botones, los tiempos y el buzzer](<video controls src="video1.mp4" title="Title"></video>).
